function Privacy() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Easy Percentage.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Easy Percentage, accessible from{' '}
            <a
              href="https://www.easypercentage.net/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.easypercentage.net/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mario.molocea@gmail.com</li>
      </ul>
    </div>
  )
}
